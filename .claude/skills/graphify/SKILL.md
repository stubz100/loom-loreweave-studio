...
# This project pins the pilot version. Never auto-install or auto-upgrade from a skill invocation.
if (-not $GRAPHIFY_PYTHON) {
    throw "Graphify 0.8.44 is not available. Stop and follow .docs/kb-tok-reduce-imp.md; do not auto-install or upgrade."
}
...
1. **Reinstall the pinned pilot**: `uv tool install --force "graphifyy==0.8.44"`
