...
| | **GraphRAG retrieval index** (typed project graph + same `Qwen3-VL-Embedding` model) | R138/R170 | §6 — MOVED OUT: spike P2, implementation P4 (author 2026-07-05) |
...
- **GraphRAG retrieval index (R138/R170).** P4 shipped *text* project-context (R145) plus a
  ...
  retrieval layer unbuilt. **Author 2026-07-05 (R170 amended): the index is now a P4 deliverable
  (spike in P2) — P6 no longer owns it.** This section stays as the stack's reference; P4 builds the real GraphRAG stack: ingest typed project facts into a graph,
...
| **R138** | Persistent retrieval index (same Qwen3-VL-Embedding model; spike P2 / implemented P4 — 2026-07-05). |
| **R170** | GraphRAG posture: typed facts in P2/P4 now, persistent graph/vector index + retrieval/query moved: **spike P2, implementation P4** (author 2026-07-05). |
