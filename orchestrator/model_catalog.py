    ...
    return {
        ...
        "sd35": {
            ...
            "params": [
                ...
                # P2/M5 (spike GO 2026-08-08): sd35 trains character LoRAs, so it must be able
                # to LOAD one — same three flags as zimage. Needs PEFT, which rides in on the
                # trainer overlay (R103) via the job's `runtime_overlay`.
