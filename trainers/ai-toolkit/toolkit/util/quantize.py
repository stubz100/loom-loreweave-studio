...
try:
    ...
    # Windows ROCm PyTorch omits distributed_c10d, while torchao imports it eagerly.
    # Keep optimum-quanto qtypes (notably qfloat8) available without torchao.
    torchao_quantize_ = None
    Float8WeightOnlyConfig = UIntXWeightOnlyConfig = Int8WeightOnlyConfig = None
...
torchao_qtypes = {} if torchao_quantize_ is None else {
